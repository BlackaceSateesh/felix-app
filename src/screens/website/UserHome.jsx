...
import metamaskWalletIcon from "../../assets/wallet/metamask.png";
    ...
    <>
      <div className="UserHome" id="home">
        ...
        >
          <div className="inner">
            <div className="left">
              <h1 data-aos="fade-right" className="title textBg" style={{backgroundImage: `url(${trainGif2})`}}>
                {UserWebsiteContent?.heroSection?.title}
              </h1>
              <h1 data-aos="fade-right" className="title textBg" style={{backgroundImage: `url(${trainGif})`}} >
          ...
          {/* <div className="inner">
            <div className="count-numbers">
              <div className="ss-card">
                <h2 className="name">Total Trade Volume</h2>
                <span className="count">$54542</span>
              </div>
              <div className="ss-card">
                <h2 className="name">Total Investor</h2>
                <span className="count">$54542</span>
              </div>
              <div className="ss-card">
                <h2 className="name">Active Users</h2>
                <span className="count">54542</span>
              </div>
            </div>
            </div> */}
